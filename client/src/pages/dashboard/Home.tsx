                        ...
                        <div className="mx-auto max-w-lg">
                            <Zoom triggerOnce>
                                <h1 className="text-3xl font-bold text-gray-800 dark:text-white md:text-4xl">
                                    Create beautiful website layout with Huemn.
                                </h1>

                                <p className="mt-6 text-gray-500 dark:text-gray-300">
                                    Lorem ipsum dolor sit, amet consectetur
                                    adipisicing elit. Libero similique obcaecati
                                    illum mollitia.
                                </p>
                        ...
                        <Bounce cascade damping={200}>
                            <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:mt-16 xl:grid-cols-3">
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-2 text-sm text-gray-500 dark:text-gray-300">
                                            ...
                                            Provident placeat, consequatur
                                            eveniet veritatis quos dignissimos
                                            beatae dolores exercitationem
                                            laboriosam officia magnam atque
                                            blanditiis illum doloremque magni ex
                                ...
                                <div>
                                    ...
                                    <div>
                                        <h1 className="text-xl font-semibold text-gray-700 dark:text-white">
                                            What are the parking and public
                                            transport options?
                                        </h1>
